...
// Sprawdź, czy zmienne są przekazane poprawnie
...
$slowa = $_SESSION['slowa']; // Pobieranie słów z sesji
$punkty = 0;
$bledy = [];

// Przetwarzanie pytań wielokrotnego wyboru
for ($i = 0; $i < 4; $i++) {
...
// Przydzielanie oceny na podstawie punktów
if ($punkty >= 19) {
    $ocena = "5";
} elseif ($punkty >= 17) {
    $ocena = "4+";
